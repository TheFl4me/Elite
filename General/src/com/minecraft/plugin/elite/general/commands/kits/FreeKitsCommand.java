...
public class FreeKitsCommand extends GeneralCommand {
    ...
    public boolean execute(CommandSender cs, Command cmd, String[] args) {
        ...
        System.out.println(this.getLanguage().get((free ? com.minecraft.plugin.elite.general.GeneralLanguage.KIT_FREE_TRUE : com.minecraft.plugin.elite.general.GeneralLanguage.KIT_FREE_FALSE)));
        for(Player all : Bukkit.getOnlinePlayers()) {
            GeneralPlayer p = GeneralPlayer.get(all);
            if(free)
                p.sendMessage(com.minecraft.plugin.elite.general.GeneralLanguage.KIT_FREE_TRUE);
            else
                p.sendMessage(com.minecraft.plugin.elite.general.GeneralLanguage.KIT_FREE_FALSE);
        }
        return true;
    }
}
